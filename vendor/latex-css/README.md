...
```html
<link rel="stylesheet" href="../vendor/latex-css/style.min.css" />
```
...
Add any optional classnames to elements with special styles (author subtitle, abstract, lemmas, theorems, etc.). A list of supported class-based elements can be found [here](../vendor/latex-css/#class-based-elements).
...
```html
<link rel="stylesheet" href="../vendor/latex-css/lang/es.css" />
```
...
Have a look at the [language support page](../vendor/latex-css/languages) for more info and a demo of the different languages.
...
The sample [HTML5 markup test page](../vendor/latex-css/elements) is based on [html5-test-page](https://github.com/cbracco/html5-test-page) by @cbracco.
